...
import '../ProductContent/CartNumPdp.dart';
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                SizedBox(width: 10),
                                CartNumPdp(this._productContent)
                              ],
                            ),
                          ),
                          Divider()
            ...
            child: SlideTransition(
              ...
              child: ScaleTransition(
                ...
                child: Image.network("${pic}",
                    fit: BoxFit.fill, opacity: _animationOpacity),
              ),
            ),
          ),
          //标题
