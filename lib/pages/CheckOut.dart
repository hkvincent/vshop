...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var allPrice = CheckOutServices.getAllPrice(
        ...
        .toStringAsFixed(1);
    var finalPrice = double.parse(allPrice) - 5;
    return Scaffold(
      appBar: AppBar(
                  ...
                  children: <Widget>[
                    ...
                    this._addressList.length > 0
                        ...
                        : ListTile(
                            ...
                            title: Center(
                              child: Text("please ass the new address."),
                            ),
                            trailing: Icon(Icons.navigate_next),
                            onTap: () {
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Total: ${finalPrice}", style: TextStyle(color: Colors.red)),
                  ),
                  Align(
                    alignment: Alignment.centerRight,
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        if (this._addressList.length > 0) {
                          ...
                          print("size: ${this._addressList.length}");
                          Fluttertoast.showToast(
                            msg: 'address book is empty',
